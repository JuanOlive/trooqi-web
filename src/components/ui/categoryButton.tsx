...
export default function Dropdown() {
  ...
  return (
    <div className="relative transition-all duration-300" >
      ...
      <button onClick={() => setIsOpen(!isOpen)} className="flex items-center text-[#875a38] text-shadow-sm font-semibold px-4 py-2 rounded-lg focus:outline-none transition-all duration-300 outline-none">
         Oque deseja?
